...
class Household(Agent):
    ...
    def __init__(self, model, TPB_weights=None):
        ...
        # # -- GENERAL ATTRIBUTES -- #
        # TODO: fix negative income (cap at unemployment subsidy)
        ...
        self.PV_costs = 1484 + self.number_of_PVs * 428
        self.NPV = self.estimate_NPV()
        self.CE_ratio = self.estimate_CE()
    ...
    def TPB(self):
        ...
        (self.TPB_attributes["PV"][2],
            self.TPB_attributes["no_PV"][2]) = self.NPV / self.model.max_NPV
